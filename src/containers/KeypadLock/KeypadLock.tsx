  ...
  return (
    <div className="container p-5">
      <div className="keypad col-4 border border-3 rounded-3">
        <div
          className="border border-2 p-2 mx-4 my-3 rounded-3"
          style={{
            backgroundColor:
              access === "pass"
                ? "lightgreen"
        ...
        <div className="px-5">
          <div className="d-flex flex-lg-wrap px-2 gap-2 justify-content-center">
            {buttons.map((button) => (
              <button
                key={button}
                onClick={() => dispatch(writeInput(button))}
                className="btn p-3 btn-lg btn-light border border-2"
              >
                {button}{" "}
              </button>
            ))}
          ...
          <div className="p-2 d-flex gap-2 mb-3 justify-content-center">
            ...
            <button
              onClick={() => dispatch(writeInput("*"))}
              className="btn p-3 btn-lg btn-light border border-2"
            >
              0
            </button>
            <button
              onClick={() => dispatch(checkPin())}
              className="btn p-3 btn-lg btn-light border border-2"
            >
              E
            </button>
